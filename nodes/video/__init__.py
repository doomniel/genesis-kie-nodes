...
Each model family lives in its own module. This file aggregates their
...
from . import grok, happyhorse, hailuo, kling, seedance, veo31

NODE_CLASS_MAPPINGS: dict[str, type] = {}
NODE_DISPLAY_NAME_MAPPINGS: dict[str, str] = {}

for module in (veo31, kling, seedance, hailuo, happyhorse, grok):
